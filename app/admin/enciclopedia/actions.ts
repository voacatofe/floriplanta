...
import { type EncyclopediaCategory, toEncyclopediaCategory } from '@/app/lib/encyclopedia';
...
export async function getTermForEdit(termId: string) {
  ...
  try {
    ...
    // Converter tipos do Prisma para os tipos TypeScript esperados
    const convertedTerm = {
      ...term,
      category: toEncyclopediaCategory(term.category),
      // Manter as datas como objetos Date (não converter para string)
    };
