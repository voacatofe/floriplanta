...
export default function SobreNosPage() {
  return (
    <main className="bg-[#f8f5f0] overflow-x-hidden">
      ...
      <section className="py-16 lg:py-20 bg-brand-light-green/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-12">
            ...
            <div className="md:col-span-1 text-center p-6 bg-white rounded-xl shadow-sm flex flex-col justify-center">
               <Heart className="w-10 h-10 text-brand-purple mx-auto mb-4" />
              <h3 className="font-futuru font-bold text-brand-purple text-2xl mb-3">Valores</h3>
              <p className="font-inter text-brand-purple/80 text-sm leading-relaxed">
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-futuru font-bold text-brand-purple text-3xl lg:text-4xl mb-6 text-center">As Pessoas por Trás da Floriplanta</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-10">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <Image 
                  src={member.image} 
                  alt={member.name} 
                  width={120} 
                  height={120} 
                  className="rounded-full mx-auto mb-4 border-4 border-brand-light-green"
                />
                <h3 className="font-futuru font-bold text-brand-purple text-xl mb-1">{member.name}</h3>
                <p className="font-inter font-medium text-brand-hover-purple text-sm mb-2">{member.role}</p>
                <p className="font-inter text-brand-purple/70 text-xs leading-relaxed">{member.bio}</p>
              </div>
            ))}
