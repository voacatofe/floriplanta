      ...
      <div className="container mx-auto px-4 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center justify-end flex-shrink-0 gap-3 xl:gap-4">
            <Link href="/loja"
              className="flex items-center justify-center gap-2 px-3 py-2 xl:px-4 xl:py-2.5 bg-brand-purple text-white rounded-lg font-futuru font-medium hover:bg-brand-hover-purple transition-colors duration-200 text-xs xl:text-sm whitespace-nowrap transform hover:scale-105 active:scale-95">
