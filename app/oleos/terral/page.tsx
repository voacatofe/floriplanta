...
export default function OleoTerralPage() {
  return (
    <main className="bg-[#f8f5f0] overflow-x-hidden">
      {/* Page Header - Simplified for product page */}
      <section className="pt-24 pb-10 lg:pt-32 lg:pb-12 bg-gradient-to-b from-white to-brand-light-green/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6">
            ...
            <h1 className="font-futuru font-bold text-brand-purple text-3xl lg:text-4xl">Óleo CBD Full Spectrum - Terral</h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/3">
              <div className="relative aspect-square bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden sticky top-24">
                <Image 
                  src="/images/products/oleo-terral-cbd.jpg" 
                  alt="Floriplanta Óleo CBD Full Spectrum - Terral 20mg/mL" 
                  layout="fill" 
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="prose prose-lg max-w-none prose-headings:font-futuru prose-headings:text-brand-purple prose-a:text-brand-hover-purple hover:prose-a:text-brand-purple mb-8">
                <p className="text-lg italic text-brand-purple/85">
                  Assim como o vento terral acalma o mar, nosso óleo Terral, rico em Canabidiol (CBD) Full Spectrum, traz relaxamento e equilíbrio. Ideal para auxiliar no manejo da ansiedade, inflamações e na busca por bem-estar geral, sempre sob orientação médica.
                </p>
              ...
              <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <ul className="font-inter text-brand-purple/85 text-sm space-y-2">
                  ...
                  <li><strong>Perfil:</strong> Predominantemente CBD</li>
              ...
              <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-2">
                  ...
                  <Link href="#" target="_blank" rel="noopener noreferrer" className="block font-inter text-brand-hover-purple hover:underline text-sm">
                    Laudo Lote [XXXX] - Potência - Óleo Terral (PDF)
                  </Link>
                  <Link href="#" target="_blank" rel="noopener noreferrer" className="block font-inter text-brand-hover-purple hover:underline text-sm">
                    Laudo Lote [XXXX] - Pureza - Óleo Terral (PDF)
                  </Link>
                </div>
