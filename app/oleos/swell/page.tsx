...
export default function OleoSwellPage() {
  return (
    <main className="bg-[#f8f5f0] overflow-x-hidden">
      ...
      {/* Page Header */}
      <section className="pt-24 pb-10 lg:pt-32 lg:pb-12 bg-gradient-to-b from-white to-brand-hover-purple/10"> {/* Adjusted gradient */}
        <div className="container mx-auto px-4">
          <div className="text-center mb-6">
            ...
            <h1 className="font-futuru font-bold text-brand-purple text-3xl lg:text-4xl">Óleo THC Full Spectrum - Swell</h1>
            <p className="font-inter text-brand-hover-purple text-lg mt-1">20mg/mL Canabinoides Totais</p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-1/3">
              <div className="relative aspect-square bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden sticky top-24">
                <Image 
                  src="/images/products/oleo-swell-thc.jpg" 
                  alt="Floriplanta Óleo THC Full Spectrum - Swell 20mg/mL" 
                  layout="fill" 
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="prose prose-lg max-w-none prose-headings:font-futuru prose-headings:text-brand-purple prose-a:text-brand-hover-purple hover:prose-a:text-brand-purple mb-8">
                <p className="text-lg italic text-brand-purple/85">
                  Com a potência e energia das grandes ondulações (swell), nosso óleo Swell, rico em Tetrahidrocanabinol (THC) Full Spectrum, alinha-se a um efeito mais estimulante e expansivo. Indicado sob prescrição para condições como dor crônica e falta de apetite, sempre sob orientação médica.
                </p>
              ...
              <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <ul className="font-inter text-brand-purple/85 text-sm space-y-2">
                  ...
                  <li><strong>Perfil:</strong> Predominantemente THC</li>
                  <li><strong>Outros Canabinoides:</strong> Contém outros canabinoides menores (CBD, CBG, etc.) e terpenos presentes naturalmente na planta (conforme laudo).</li>
              ...
              <div className="mb-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-2">
                  ...
                  <Link href="#" target="_blank" rel="noopener noreferrer" className="block font-inter text-brand-hover-purple hover:underline text-sm">
                    Laudo Lote [XXXX] - Potência - Óleo Swell (PDF)
                  </Link>
                  <Link href="#" target="_blank" rel="noopener noreferrer" className="block font-inter text-brand-hover-purple hover:underline text-sm">
                    Laudo Lote [XXXX] - Pureza - Óleo Swell (PDF)
                  </Link>
                </div>
