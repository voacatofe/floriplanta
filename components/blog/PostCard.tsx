    ...
    <article className="mb-8 overflow-hidden rounded-lg border border-gray-200 shadow-sm transition hover:shadow-md dark:border-gray-700 dark:shadow-gray-700/25">
      ...
      <div className="p-4 sm:p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3">
          {post.content ? post.content.substring(0, 150) + '...' : 'Leia mais...'}
        </p>

        <div className="mt-4 text-xs text-gray-500 dark:text-gray-400">
          <p>
            Por: <span className="font-medium text-gray-700 dark:text-gray-200">{post.author?.name || 'Autor desconhecido'}</span>
          </p>
